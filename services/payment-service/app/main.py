...
app = FastAPI(
    title="RepitBot Payment Service",
    version="1.0.0",
    openapi_url=f"{settings.api_prefix}/payments/openapi.json",
    docs_url=f"{settings.api_prefix}/payments/docs" if settings.debug else None,
)
